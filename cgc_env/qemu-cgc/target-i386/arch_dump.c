                                  ...
                                  int id)
{
    ...
    prstatus->regs.rbp = env->regs[R_EBP] & 0xffffffff;
    prstatus->regs.rsp = env->regs[R_ESP] & 0xffffffff;
    prstatus->regs.rdi = env->regs[R_EDI] & 0xffffffff;
    prstatus->regs.rsi = env->regs[R_ESI] & 0xffffffff;
    prstatus->regs.rdx = env->regs[R_EDX] & 0xffffffff;
    prstatus->regs.rcx = env->regs[R_ECX] & 0xffffffff;
    prstatus->regs.rbx = env->regs[R_EBX] & 0xffffffff;
    prstatus->regs.rax = env->regs[R_EAX] & 0xffffffff;
    prstatus->regs.rip = env->rip & 0xffffffff;
